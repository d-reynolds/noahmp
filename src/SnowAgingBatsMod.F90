    ...
    do J = noahmp%config%domain%JTS, noahmp%config%domain%JTE
      do I = noahmp%config%domain%ITS, noahmp%config%domain%ITE
        ...
        associate(                                                                     &
                  ...
                  SnowAgeFacBats       => noahmp%energy%param%SnowAgeFacBats(I,J)     ,& ! in,    snow aging parameter
                  SnowGrowVapFacBats   => noahmp%energy%param%SnowGrowVapFacBats(I,J) ,& ! in,    vapor diffusion snow growth factor
                  SnowGrowFrzFacBats   => noahmp%energy%param%SnowGrowFrzFacBats(I,J) ,& ! in,    extra snow growth factor near freezing
                  SnowSootFacBats      => noahmp%energy%param%SnowSootFacBats(I,J)    ,& ! in,    dirt and soot effect factor
                  ...
                  SnowWaterEquivPrev   => noahmp%water%state%SnowWaterEquivPrev(I,J)  ,& ! in,    snow water equivalent at previous time step [mm]
                  SnowAgeNondim        => noahmp%energy%state%SnowAgeNondim(I,J)      ,& ! inout, non-dimensional snow age
                  SnowAgeFac           => noahmp%energy%state%SnowAgeFac(I,J)          & ! out,   snow age factor
                 )
! ----------------------------------------------------------------------
